...
class QuizActivity : AppCompatActivity() {
    ...
    var isAnswer: Boolean = false // isAnswer 쓰려면 isHint도 true여야됨

    var quitLeft: Int = 5;

    var isReadOnly: Boolean = false // 이거 true이면 isAnswer은 false여도 상관 없음 하지만 isHint는 true여야 함
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isAnswer = intent.getBooleanExtra("isAnswer", false)
                        ...
                        MainActivity.run {
                            AlertDialog.Builder(this@QuizActivity)
                                ...
                                .setPositiveButton("채점하기") { dialog, id ->
                                    ...
                                    intent.putExtra("ScoreSave", !isHint)
        ...
        if (isHint) {
            quiz_hint.setOnClickListener {
                ...
                AlertDialog.Builder(this)
                    ...
                    .setMessage(nowQuiz.hint + if (isReadOnly || isAnswer) "\n정답 : ${nowQuiz.answer}" else "")
